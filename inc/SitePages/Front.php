...
{
  // todo (step 2): remove this method if not needed
  ...
  {
    // todo (step 2): remove this line and corresponding js src and dist files if not needed
    Assets::enqueue_local_js( 'page-front' );
  }

  protected function enqueue_css() : void
  {
    // todo (step 2): remove this line and corresponding css src and dist files if not needed
